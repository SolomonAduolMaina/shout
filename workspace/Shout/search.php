...
if ($query_type == "All" || $query_type == "Friends") {
	$friends_query = "SELECT DISTINCT User.*, Connection.friend_id = $user_id 
...
if ($query_type == "All" || $query_type == "Groups") {
